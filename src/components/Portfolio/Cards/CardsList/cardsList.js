...
export default [
    ...
    },
    {
        ...
        description: ["This is a responsive page with 3 display sizes, mobile first. Here I'm using the open source API for crypto widgets. Markup and CSS were used with BEM methodology and fully validated. The registration form contains Email and Password fields with validation rules. Registration button activates after client validation pass, and Success message shows on submit."],
        ...
        links: [
            <a href="https://github.com/joana-trots/xm-zero-swaps" target="_blank" title="See Github repository" rel="noreferrer"><FontAwesomeIcon icon={faGithub} /></a>,
            <a href="https://joana-trots.github.io/xm-zero-swaps" target="_blank" title="See Live project" rel="noreferrer"><FontAwesomeIcon icon={faEye} /></a>
        ]
    },
    {
        id: 17,
